...
namespace Refal.Runtime
{
	public class Program : RefalBase
	{
		...
		private static PassiveExpression Job(PassiveExpression expression)
		{
			...
			{
				return PassiveExpression.Build(Prout(PassiveExpression.Build("Type expression to evaluate. To end: empty line. ".ToCharArray())), Prout(PassiveExpression.Build("To end session: empty expression".ToCharArray())), Prout(PassiveExpression.Build()), Check__end(PassiveExpression.Build(Inp__met(PassiveExpression.Build()))));
			};

			throw new RecognitionImpossibleException("Recognition impossible");
		}

		private static PassiveExpression Check__end(PassiveExpression expression)
		{
		...
		private static PassiveExpression Inp__met(PassiveExpression expression)
		{
			Pattern pattern7 = new Pattern();
			if (RefalBase.Match(expression, pattern7))
			{
				return PassiveExpression.Build(Parse(PassiveExpression.Build(new OpeningBrace(), "$".ToCharArray(), new ClosingBrace(), Read__in(PassiveExpression.Build(Card(PassiveExpression.Build()))))));
			};
		...
		private static PassiveExpression Read__in(PassiveExpression expression)
		{
			...
			{
				return PassiveExpression.Build(" ".ToCharArray(), pattern10.GetVariable("e.1"), Read__in(PassiveExpression.Build(Card(PassiveExpression.Build()))));
			};
		...
		private static PassiveExpression Parse(PassiveExpression expression)
		{
			...
			{
				expression = PassiveExpression.Build(Checkf(PassiveExpression.Build(pattern17.GetVariable("s.F"))));
				{
					...
					if (RefalBase.Match(expression, pattern18))
					{
						...
						{
							return PassiveExpression.Build(Parse(PassiveExpression.Build(new OpeningBrace(), pattern19.GetVariable("e.1"), new OpeningBrace(), "!".ToCharArray(), "Mul", pattern19.GetVariable("e.4"), new ClosingBrace(), new ClosingBrace(), pattern19.GetVariable("e.3"))));
						}
					};
					...
					{
						return PassiveExpression.Build(Parse(PassiveExpression.Build(new OpeningBrace(), pattern20.GetVariable("e.1"), new OpeningBrace(), "!".ToCharArray(), pattern20.GetVariable("s.F1"), pattern20.GetVariable("e.2"), new ClosingBrace(), new ClosingBrace(), pattern20.GetVariable("e.3"))));
					};
					...
					{
						return PassiveExpression.Build(Prout(PassiveExpression.Build()), "*".ToCharArray(), "Error", Prout(PassiveExpression.Build("Invalid function name ".ToCharArray(), pattern21.GetVariable("s.F"))));
					};
			...
			{
				return PassiveExpression.Build(Prout(PassiveExpression.Build()), "*".ToCharArray(), "Error", Prout(PassiveExpression.Build("*** ERROR: No function name in input".ToCharArray())), Prout(PassiveExpression.Build(pattern23.GetVariable("e.1"), "*(?????".ToCharArray())));
			};
			...
			{
				return PassiveExpression.Build(Prout(PassiveExpression.Build()), "*".ToCharArray(), "Error", Prout(PassiveExpression.Build("*** ERROR: Unbalanced \'>\' in input".ToCharArray())), Prout(PassiveExpression.Build(pattern24.GetVariable("e.1"), ">".ToCharArray())));
			};
			...
			{
				return PassiveExpression.Build(Parse(PassiveExpression.Build(new OpeningBrace(), pattern25.GetVariable("e.1"), "*V".ToCharArray(), new ClosingBrace(), pattern25.GetVariable("e.2"))));
			};
			...
			if (RefalBase.Match(expression, pattern28))
			{
				expression = PassiveExpression.Build(pattern28.GetVariable("e.2"));
				{
					...
					{
						expression = PassiveExpression.Build(Hex(PassiveExpression.Build(pattern29.GetVariable("s.d1"), pattern29.GetVariable("s.d2"))));
						...
						{
							return PassiveExpression.Build(Parse(PassiveExpression.Build(new OpeningBrace(), pattern30.GetVariable("e.1"), pattern30.GetVariable("s.hex"), new ClosingBrace(), pattern30.GetVariable("e.3"))));
						}
					};
					...
					{
						expression = PassiveExpression.Build(Escape(PassiveExpression.Build(pattern31.GetVariable("s.A"))));
						...
						{
							return PassiveExpression.Build(Parse(PassiveExpression.Build(new OpeningBrace(), pattern32.GetVariable("e.1"), pattern32.GetVariable("s.A1"), new ClosingBrace(), pattern32.GetVariable("e.3"))));
						}
					};
					...
					{
						return PassiveExpression.Build(Prout(PassiveExpression.Build()), "*".ToCharArray(), "Error", Prout(PassiveExpression.Build("*** ERROR: Unexpected escape sequnce in input".ToCharArray())), Prout(PassiveExpression.Build("*** ".ToCharArray(), pattern33.GetVariable("e.1"))), Prout(PassiveExpression.Build("*** ".ToCharArray(), "\\".ToCharArray(), pattern33.GetVariable("e.3"))));
					};
			...
			{
				return PassiveExpression.Build(Parse1(PassiveExpression.Build(new OpeningBrace(), pattern35.GetVariable("e.1"), new ClosingBrace(), new OpeningBrace(), Type(PassiveExpression.Build(pattern35.GetVariable("s.A"))), new ClosingBrace(), pattern35.GetVariable("s.A"), pattern35.GetVariable("e.2"))));
			};
			...
			{
				return PassiveExpression.Build(Prout(PassiveExpression.Build()), "*".ToCharArray(), "Error", Prout(PassiveExpression.Build("*** ERROR: Unbalanced \'(\' or \'<\' in input".ToCharArray())), Prout__lm(PassiveExpression.Build(new OpeningBrace(), pattern37.GetVariable("e.1"), new ClosingBrace(), pattern37.GetVariable("e.2"))));
			};
		...
		private static PassiveExpression Checkf(PassiveExpression expression)
		{
			...
			{
				expression = PassiveExpression.Build(Type(PassiveExpression.Build(pattern42.GetVariable("s.F"))));
		...
		private static PassiveExpression Prout__lm(PassiveExpression expression)
		{
			...
			{
				return PassiveExpression.Build(Prout__lm(PassiveExpression.Build(pattern45.GetVariable("e.1"))), Prout(PassiveExpression.Build("*** *(".ToCharArray(), pattern45.GetVariable("e.2"))));
			};
			...
			{
				return PassiveExpression.Build(Prout__lm(PassiveExpression.Build(pattern46.GetVariable("e.1"))), Prout(PassiveExpression.Build("*** (".ToCharArray(), pattern46.GetVariable("e.2"))));
			};

			Pattern pattern47 = new Pattern("$".ToCharArray(), new ExpressionVariable("e.1"));
			if (RefalBase.Match(expression, pattern47))
			{
				return PassiveExpression.Build(Prout(PassiveExpression.Build("*** ".ToCharArray(), pattern47.GetVariable("e.1"))));
			};
		...
		private static PassiveExpression Quotes(PassiveExpression expression)
		{
			...
			if (RefalBase.Match(expression, pattern59))
			{
				expression = PassiveExpression.Build(pattern59.GetVariable("e.2"));
				{
					...
					{
						expression = PassiveExpression.Build(Hex(PassiveExpression.Build(pattern60.GetVariable("s.d1"), pattern60.GetVariable("s.d2"))));
						...
						{
							return PassiveExpression.Build(Quotes(PassiveExpression.Build(pattern61.GetVariable("s.Fun"), pattern61.GetVariable("s.Q"), new OpeningBrace(), pattern61.GetVariable("e.1"), pattern61.GetVariable("s.hex"), new ClosingBrace(), pattern61.GetVariable("e.3"))));
						}
					};
					...
					{
						expression = PassiveExpression.Build(Escape(PassiveExpression.Build(pattern62.GetVariable("s.A"))));
						...
						{
							return PassiveExpression.Build(Quotes(PassiveExpression.Build(pattern63.GetVariable("s.Fun"), pattern63.GetVariable("s.Q"), new OpeningBrace(), pattern63.GetVariable("e.1"), pattern63.GetVariable("s.A1"), new ClosingBrace(), pattern63.GetVariable("e.3"))));
						}
					};
					...
					{
						return PassiveExpression.Build(Prout(PassiveExpression.Build()), "*".ToCharArray(), "Error", Prout(PassiveExpression.Build("*** ERROR: Unexpected escape sequnce in input".ToCharArray())), Prout(PassiveExpression.Build("*** ".ToCharArray(), pattern64.GetVariable("e.1"))), Prout(PassiveExpression.Build("*** ".ToCharArray(), "\\".ToCharArray(), pattern64.GetVariable("e.3"))));
					};
			...
			{
				return PassiveExpression.Build(Mu(PassiveExpression.Build(pattern66.GetVariable("s.Fun"), new OpeningBrace(), pattern66.GetVariable("e.1"), new ClosingBrace(), pattern66.GetVariable("e.2"))));
			};
			...
			{
				return PassiveExpression.Build(Mu(PassiveExpression.Build(pattern67.GetVariable("s.Fun"), new OpeningBrace(), pattern67.GetVariable("e.0"), Implode_Ext(PassiveExpression.Build(pattern67.GetVariable("e.1"))), new ClosingBrace(), pattern67.GetVariable("e.2"))));
			};
			...
			{
				return PassiveExpression.Build(QuotesError(PassiveExpression.Build(pattern68.GetVariable("s.Q"), new OpeningBrace(), pattern68.GetVariable("e.1"), new ClosingBrace())));
			};
			...
			{
				return PassiveExpression.Build(Quotes(PassiveExpression.Build(pattern69.GetVariable("s.Fun"), "\'".ToCharArray(), new OpeningBrace(), pattern69.GetVariable("e.1"), "*V".ToCharArray(), new ClosingBrace(), pattern69.GetVariable("e.2"))));
			};
			...
			{
				return PassiveExpression.Build(Quotes(PassiveExpression.Build(pattern70.GetVariable("s.Fun"), pattern70.GetVariable("s.Q"), new OpeningBrace(), pattern70.GetVariable("e.1"), pattern70.GetVariable("s.A"), new ClosingBrace(), pattern70.GetVariable("e.2"))));
			};
			...
			{
				return PassiveExpression.Build(QuotesError(PassiveExpression.Build(pattern71.GetVariable("s.Q"), new OpeningBrace(), pattern71.GetVariable("e.1"), new ClosingBrace())));
			};
		...
		private static PassiveExpression QuotesError(PassiveExpression expression)
		{
			...
			{
				return PassiveExpression.Build(Prout(PassiveExpression.Build()), "*".ToCharArray(), "Error", Prout(PassiveExpression.Build("*** ERROR: Unbalanced quote in input".ToCharArray())), Prout(PassiveExpression.Build("*** ".ToCharArray(), pattern72.GetVariable("e.1"))), Prout(PassiveExpression.Build("*** ".ToCharArray(), pattern72.GetVariable("s.Q"))));
			};
		...
		private static PassiveExpression Hex(PassiveExpression expression)
		{
			...
			{
				expression = PassiveExpression.Build(Hex(PassiveExpression.Build(pattern73.GetVariable("s.d1"))));
				...
				{
					expression = PassiveExpression.Build(Hex(PassiveExpression.Build(pattern74.GetVariable("s.d2"))));
					...
					{
						return PassiveExpression.Build(Chr(PassiveExpression.Build(Add(PassiveExpression.Build(new OpeningBrace(), Mul(PassiveExpression.Build(pattern75.GetVariable("s.h1"), 16)), new ClosingBrace(), pattern75.GetVariable("s.h2"))))));
					}
				}
			};
			...
			{
				expression = PassiveExpression.Build(Type(PassiveExpression.Build(pattern76.GetVariable("s.h"))));
		...
		private static PassiveExpression Parse1(PassiveExpression expression)
		{
			...
			{
				return PassiveExpression.Build(Word(PassiveExpression.Build(new OpeningBrace(), pattern91.GetVariable("e.1"), new ClosingBrace(), new OpeningBrace(), pattern91.GetVariable("s.A"), new ClosingBrace(), pattern91.GetVariable("e.2"))));
			};
			...
			{
				return PassiveExpression.Build(Number(PassiveExpression.Build(new OpeningBrace(), pattern92.GetVariable("e.1"), new ClosingBrace(), new OpeningBrace(), pattern92.GetVariable("s.A"), new ClosingBrace(), pattern92.GetVariable("e.2"))));
			};
			...
			{
				return PassiveExpression.Build(Parse(PassiveExpression.Build(new OpeningBrace(), pattern93.GetVariable("e.1"), pattern93.GetVariable("s.A"), new ClosingBrace(), pattern93.GetVariable("e.2"))));
			};
		...
		private static PassiveExpression Word(PassiveExpression expression)
		{
			...
			{
				expression = PassiveExpression.Build(Type(PassiveExpression.Build(pattern94.GetVariable("s.B"))));
				{
					...
					{
						return PassiveExpression.Build(Word(PassiveExpression.Build(new OpeningBrace(), pattern95.GetVariable("e.1"), new ClosingBrace(), new OpeningBrace(), pattern95.GetVariable("e.W"), pattern95.GetVariable("s.B"), new ClosingBrace(), pattern95.GetVariable("e.2"))));
					};
					...
					{
						return PassiveExpression.Build(Word(PassiveExpression.Build(new OpeningBrace(), pattern96.GetVariable("e.1"), new ClosingBrace(), new OpeningBrace(), pattern96.GetVariable("e.W"), pattern96.GetVariable("s.B"), new ClosingBrace(), pattern96.GetVariable("e.2"))));
					};
					...
					{
						return PassiveExpression.Build(Word(PassiveExpression.Build(new OpeningBrace(), pattern97.GetVariable("e.1"), new ClosingBrace(), new OpeningBrace(), pattern97.GetVariable("e.W"), "-".ToCharArray(), new ClosingBrace(), pattern97.GetVariable("e.2"))));
					};
					...
					{
						return PassiveExpression.Build(Word(PassiveExpression.Build(new OpeningBrace(), pattern98.GetVariable("e.1"), new ClosingBrace(), new OpeningBrace(), pattern98.GetVariable("e.W"), "_".ToCharArray(), new ClosingBrace(), pattern98.GetVariable("e.2"))));
					};
					...
					{
						return PassiveExpression.Build(Parse(PassiveExpression.Build(new OpeningBrace(), pattern99.GetVariable("e.1"), Implode_Ext(PassiveExpression.Build(pattern99.GetVariable("e.W"))), new ClosingBrace(), pattern99.GetVariable("s.B"), pattern99.GetVariable("e.2"))));
					};
			...
			{
				return PassiveExpression.Build(Parse(PassiveExpression.Build(new OpeningBrace(), pattern101.GetVariable("e.1"), Implode_Ext(PassiveExpression.Build(pattern101.GetVariable("e.W"))), new ClosingBrace())));
			};
		...
		private static PassiveExpression Number(PassiveExpression expression)
		{
			...
			{
				expression = PassiveExpression.Build(Type(PassiveExpression.Build(pattern102.GetVariable("s.X"))));
				...
				{
					return PassiveExpression.Build(Number(PassiveExpression.Build(new OpeningBrace(), pattern103.GetVariable("e.1"), new ClosingBrace(), new OpeningBrace(), pattern103.GetVariable("e.N"), pattern103.GetVariable("s.X"), new ClosingBrace(), pattern103.GetVariable("e.2"))));
				}
			};
			...
			{
				return PassiveExpression.Build(Parse(PassiveExpression.Build(new OpeningBrace(), pattern104.GetVariable("e.1"), Numb(PassiveExpression.Build(pattern104.GetVariable("e.N"))), new ClosingBrace(), pattern104.GetVariable("e.X"))));
			};
