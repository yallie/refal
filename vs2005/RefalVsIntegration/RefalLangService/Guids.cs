...
namespace yallie.RefalLangService
{
    static class GuidList
    {
        ...
        public const string guidRefalLangServiceClassString = "8c0af5c8-60a2-4120-b53f-c526f6a0edd1";

        public static readonly Guid guidRefalLangServicePkg = new Guid(guidRefalLangServicePkgString);
        public static readonly Guid guidRefalLangServiceClass = new Guid(guidRefalLangServiceClassString);
    };
}